...
root=tk.Tk()
root.title("Covid'19 Mortality Predictor")
...
def user_input():
    ...
    submit_btn=Button(root,text="SUBMIT",command=lambda:[entry(),back_button.destroy(),home_button.destroy()],font='Raleway',bg="#00ff00",fg='white',height=1,width=8)
...
var=IntVar()
def home():
    R_btn1=tk.Button(root,text='SINGLE INPUT',command=lambda:[user_input(),R_btn1.destroy(),R_btn2.destroy(),exit_btn.destroy()],font='Raleway',bg="#20bebe",fg='white',height=2,width=15)
    R_btn1.grid(column=1,row=2)
    R_btn2=tk.Button(root,text="MULTIPLE INPUT",command=lambda:[csv_input(),R_btn1.destroy(),R_btn2.destroy(),exit_btn.destroy()],font='Raleway',bg="#20bebe",fg='white',height=2,width=15)
