...
def csv_input():
    ...
    def arr_com():
        ...
        print("__________________________")
        print("No. of patients Predicted Serious by atleast 3 Algorithms:",three+four+five,"[",(three+four+five)/2000*100,"%]")
        print("                               ____                ")
        print("No. of patients Predicted Serious by atleast 4 Algorithms:",four+five,"[",(four+five)/2000*100,"%]")
        print("                               ____                ")
        print("No. of patients Predicted Serious by all the 5 Algorithms:",five,"[",five/2000*100,"%]")
        print("                               ____                ")
        print("__________________________")
        print("__________________________")
